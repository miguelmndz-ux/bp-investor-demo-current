...
export default function HeroCard({ draftCount }: HeroCardProps) {
  return (
    <section className="fade-up relative overflow-hidden rounded-[32px] md:rounded-xl bg-gradient-to-br from-primary-container via-primary-container to-primary p-6 md:p-12 min-h-[180px] md:min-h-0 text-on-primary-container shadow-2xl border-t border-l border-orange-100/40 flex items-center justify-between">
      ...
      <div className="relative z-10 space-y-5 md:space-y-6 max-w-2xl">
