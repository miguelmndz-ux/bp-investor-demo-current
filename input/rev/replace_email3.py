    ...
    <div style="background: rgba(255,255,255,0.8); border: 1px solid rgba(255,255,255,0.5); box-shadow: 0 20px 40px rgba(163,56,0,0.08); border-radius: 24px; overflow: hidden;">
      ...
      <div style="background: linear-gradient(135deg, #fffcf0 0%, #fff2e0 40%, #ffe8d1 70%, #fff7ed 100%); margin: 20px; border-radius: 20px; padding: 28px 28px 24px; box-shadow: 0 8px 24px -4px rgba(255,107,0,0.12), inset 0 0 0 1px rgba(255,255,255,0.7);">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px;">
          <div style="display: flex; align-items: center; gap: 14px;">
            <!-- Velo logo: no border, soft shadow only -->
      ...
      <div style="margin: 0 20px 20px; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 20px rgba(163,56,0,0.06); border: 1px solid rgba(230,220,210,0.5);">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; padding: 10px 10px 0;">
          ...
          <div style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(0,0,0,0.06); box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
            ...
            <img src="http://localhost:3000/apex/velo-decode-preview.png" alt="Velo Decoded" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; object-position: top; display: block;" onerror="this.style.background='linear-gradient(135deg,#0f1432,#1e2b6e)';this.style.height='90px';this.removeAttribute('src')">
          </div>
          ...
          <div style="border-radius: 12px; overflow: hidden; border: 1px solid rgba(0,0,0,0.06); box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
            ...
            <img src="http://localhost:3000/apex/velo-microcourse-preview.png" alt="Velo Course" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; object-position: top; display: block;" onerror="this.style.background='linear-gradient(135deg,#0f2d1a,#1a5c36)';this.style.height='90px';this.removeAttribute('src')">
          </div>
        </div>

        <!-- Labels row -->
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; padding: 10px 10px 14px;">
          <div style="padding: 0 4px;">
            <div style="display: inline-block; font-size: 8px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; border-radius: 9999px; padding: 2px 8px; background: rgba(37,99,235,0.09); color: #2563eb; margin-bottom: 4px;">Decode</div>
            <div style="font-size: 12px; font-weight: 800; color: #1a0a00; line-height: 1.3;">Velo Decoded</div>
            <div style="font-size: 10px; color: #9f6c47; margin-top: 2px; line-height: 1.4;">Technical breakdown of your AI video pipeline</div>
          </div>
          <div style="padding: 0 4px;">
            <div style="display: inline-block; font-size: 8px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; border-radius: 9999px; padding: 2px 8px; background: rgba(16,185,129,0.09); color: #059669; margin-bottom: 4px;">Course</div>
            <div style="font-size: 12px; font-weight: 800; color: #1a0a00; line-height: 1.3;">Velo Course</div>
            <div style="font-size: 10px; color: #9f6c47; margin-top: 2px; line-height: 1.4;">3-module hands-on workshop for builders</div>
          </div>
        </div>
      </div>
      ...
      <div style="margin: 0 20px 20px; background: rgba(255,248,240,0.7); border-radius: 16px; padding: 22px; border: 1px solid rgba(255,220,180,0.3);">
        <div style="margin-bottom: 16px;">
          ...
          <div style="font-size: 11px; color: #9f6c47; font-weight: 600; margin-top: 3px;">Running your session</div>
        </div>
